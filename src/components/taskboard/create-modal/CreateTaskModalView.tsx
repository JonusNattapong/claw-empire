      ...
      >
        <div className="flex items-center justify-between border-b border-slate-700 px-6 py-5">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {`[${t({ ko: "임시", en: "Temp", ja: "一時", zh: "临时", th: "ชั่วคราว" })}(${draftsCount})]`}
            </button>
            <button
        ...
        <form onSubmit={onSubmit} className="flex min-h-0 flex-1 flex-col">
            ...
            <div className="min-w-0 space-y-4">
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-300">
                  {t({ ko: "제목", en: "Title", ja: "タイトル", zh: "标题", th: "หัวข้อ" })}{" "}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-slate-300">
                    {t({ ko: "업무 유형", en: "Task Type", ja: "タスク種別", zh: "任务类型", th: "ประเภทงาน" })}
                  </label>
                  <select
                    value={taskType}
          ...
          <div className="flex justify-end gap-3 border-t border-slate-700 px-6 py-4">
            ...
            >
              {submitBusy
                ? t({ ko: "생성 중...", en: "Creating...", ja: "作成中...", zh: "创建中...", th: "กำลังสร้าง..." })
