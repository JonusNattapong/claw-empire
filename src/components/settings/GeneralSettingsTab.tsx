    ...
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <ToggleSettingCard
            label={t({ ko: "자동 배정", en: "Auto Assign", ja: "自動割り当て", zh: "自动分配", th: "กำหนดอัตโนมัติ" })}
          ...
          <ToggleSettingCard
            ...
            title={t({
              ...
              zh: "启用后，策划负责人会自动分析决策步骤并继续下一步。",
              th: "เมื่อเปิดใช้งาน หัวหน้าวางแผนจะวิเคราะห์ขั้นตอนการตัดสินใจโดยอัตโนมัติและดำเนินการต่อ",
            })}
          />
          ...
          <ToggleSettingCard
            ...
            title={t({
              ...
              th: "เปิดหรือปิดการอัปเดตอัตโนมัติสำหรับเซิร์ฟเวอร์ทั้งหมด",
            })}
          />
          ...
          <ToggleSettingCard
            ...
            title={t({
              ...
              zh: "在失败/达到限制时自动切换到下一个 OAuth 账户",
              th: "สลับไปยังบัญชี OAuth ถัดไปโดยอัตโนมัติเมื่อล้มเหลว/ถึงขีดจำกัด",
            })}
          />
        </div>
