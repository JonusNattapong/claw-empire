        ...
        if (message.includes("404") || message.includes("not_found") || message.includes("repo_not_found")) {
          setBranchError(
            t({
              ...
              th: `ไม่สามารถเข้าถึง repo ${repo.full_name} ลงทะเบียน GitHub OAuth App ของคุณเองใน Settings → OAuth เพื่อเข้าถึง private repo หรือกรอก PAT ด้านล่าง`,
            }),
          );
          ...
          setBranchError(
            t({
              ...
              th: "PAT ไม่ถูกต้องหรือหมดอายุ กรุณาตรวจสอบและลองอีกครั้ง",
            }),
          );
        } else {
    ...
    if (!match) {
      setDirectInputError(
        t({
          ...
          th: "รูปแบบ: owner/repo หรือ GitHub URL",
        }),
      );
      return;
    }
    ...
    return (
      <div className="flex items-center justify-center p-8">
        <p className="text-sm text-slate-400">
          {t({ ko: "확인 중...", en: "Checking...", ja: "確認中...", zh: "检查中...", th: "กำลังตรวจสอบ..." })}
        </p>
      </div>
    );
  }
