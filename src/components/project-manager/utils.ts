...
export function getDecisionEventLabel(
  ...
  switch (eventType) {
    ...
    case "representative_pick":
      return t({ ko: "대표 선택", en: "Representative Pick", ja: "代表選択", zh: "代表选择", th: "เลือกตัวแทน" });
    case "followup_request":
      return t({ ko: "추가 요청", en: "Follow-up Request", ja: "追加依頼", zh: "追加请求", th: "คำขอเพิ่มเติม" });
