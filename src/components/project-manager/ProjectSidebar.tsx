      ...
      <div className="border-b border-slate-700 px-4 py-3">
        ...
        <div className="mt-2 flex gap-2">
          ...
          <button
            ...
            className="rounded-md bg-slate-700 px-2.5 py-1 text-xs text-slate-200 hover:bg-slate-600"
          >
            {t({ ko: "GitHub 가져오기", en: "GitHub Import", ja: "GitHub インポート", zh: "GitHub 导入", th: "นำเข้าจาก GitHub" })}
          </button>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {loadingList ? (
          ...
          <div className="px-4 py-6 text-xs text-slate-500">
            {t({ ko: "등록된 프로젝트가 없습니다", en: "No projects", ja: "プロジェクトなし", zh: "暂无项目", th: "ไม่มีโปรเจคต์ที่ลงทะเบียน" })}
          </div>
        ) : (
