          ...
          <div>
            ...
            <div className="mt-1 text-xs text-slate-400">
              {t({
                ...
                th: "แนบไฟล์ skills.md และเลือกตัวแทน CLI",
              })}
            </div>
          </div>
          <button
        ...
        <div className="space-y-4 overflow-y-auto px-5 py-4 max-h-[calc(90vh-72px)]">
          <div>
            <label className="block text-xs text-slate-400 mb-1.5">
              {t({ ko: "스킬명", en: "Skill Name", ja: "スキル名", zh: "技能名称", th: "ชื่อสกิล" })}
            </label>
            <input
              type="text"
            ...
            <div className="text-[10px] text-slate-500 mt-1">
              {t({
                ...
                th: "อนุญาตเฉพาะตัวอักษร ตัวเลข ขีดกลาง(-) และขีดล่าง(_)",
              })}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <span>📎</span>
                {t({ ko: "파일 선택", en: "Choose File", ja: "ファイル選択", zh: "选择文件", th: "เลือกไฟล์" })}
              </button>
              <input
            ...
            >
              {customSkillSubmitting ? (
                <>
                  ...
                  {t({ ko: "등록중...", en: "Submitting...", ja: "登録中...", zh: "提交中...", th: "กำลังส่ง..." })}
                </>
              ) : (
                <>
                  <span>🎓</span>
                  {t({ ko: "학습 시작", en: "Start Training", ja: "学習開始", zh: "开始培训", th: "เริ่มเทรน" })}
                </>
              )}
            </button>
          </div>
