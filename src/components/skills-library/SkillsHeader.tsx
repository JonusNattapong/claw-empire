  ...
  return (
    <div className="bg-slate-800/60 backdrop-blur-sm border border-slate-700/50 rounded-xl p-5">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            {t({
              ...
              th: "ไดเรกทอรีสกิล AI agent · ข้อมูลสดจาก skills.sh",
            })}
          </p>
        </div>
      ...
      <div className="flex gap-3">
        <div className="flex-1 relative">
          <input
            ...
            placeholder={t({
              ...
              zh: "搜索技能...（名称、仓库、分类）",
              th: "ค้นหาสกิล... (ชื่อ, repo, หมวดหมู่)",
            })}
        ...
        >
          <option value="rank">
            {t({ ko: "순위순", en: "By Rank", ja: "順位順", zh: "按排名", th: "ตามอันดับ" })}
          </option>
          <option value="installs">
            {t({ ko: "설치순", en: "By Installs", ja: "インストール順", zh: "按安装量", th: "ตามจำนวนติดตั้ง" })}
          </option>
          <option value="name">{t({ ko: "이름순", en: "By Name", ja: "名前順", zh: "按名称", th: "ตามชื่อ" })}</option>
        </select>
      </div>
    </div>
  );
