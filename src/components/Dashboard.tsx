...
export default function Dashboard({ stats, agents, tasks, companyName, onPrimaryCtaClick }: DashboardProps) {
  ...
  const primaryCtaDescription = t({
    ...
    zh: "立即创建优先任务并进入执行。",
    th: "สร้างงานสำคัญและเริ่มดำเนินการทันที",
  });
  ...
  const hudStats: HudStat[] = [
    ...
    {
      id: "clear",
      label: t({ ko: "완료율", en: "CLEAR RATE", ja: "クリア率", zh: "完成率", th: "อัตราเสร็จสิ้น" }),
      value: `${completionRate}%`,
      sub: `${numberFormatter.format(completedTasks)} ${t({ ko: "클리어", en: "cleared", ja: "クリア", zh: "完成", th: "เสร็จสิ้น" })}`,
      color: "#10b981",
      icon: "✅",
    },
    {
      id: "squad",
      label: t({ ko: "스쿼드", en: "SQUAD", ja: "スクワッド", zh: "小队", th: "ทีม" }),
      value: `${activeAgents}/${totalAgents}`,
      sub: `${t({ ko: "가동률", en: "uptime", ja: "稼働率", zh: "运行率", th: "อัตราทำงาน" })} ${activeRate}%`,
      color: "#00f0ff",
      icon: "🤖",
    },
    {
